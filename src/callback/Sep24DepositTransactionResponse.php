...
{
    /**
     * @var string $from Sent from address, perhaps BTC, IBAN, or bank account.
     */
    public string $from;

    /**
     * @var string $to Stellar address the deposited assets were sent to.
     */
    public string $to;
     ...
     * @param string $from Sent from address, perhaps BTC, IBAN, or bank account.
     * @param string $to Stellar address the deposited assets were sent to.
     ...
     * @param string $stellarTransactionId transaction id on Stellar network of the transfer that completed the deposit.
